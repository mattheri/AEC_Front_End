          ...
          <div class="modal-body">
            <div class="form-row">
              <div class="col-6 mb-3">
                ...
                <input type="text" class="form-control" id="titre" name="titre" maxlength="50" required>
              ...
              <div class="col-6 mb-3">
                ...
                <!-- Attention! Vos validations doivent être cohérentes avec le champ correspondant dans la BD! -->
                <input type="date" class="form-control" id="date_nouvelle" name="date_nouvelle" <?php echo "value='" . date('Y-m-d') . "'" ?> required>
                <div class="invalid-feedback">
            ...
            <div class="form-row align-items-center">
              <div class="col-9 mb-3">
                ...
                <!-- Attention! Vos validations doivent être cohérentes avec le champ correspondant dans la BD! -->
                <input type="text" class="form-control" id="description_courte" name="description_courte" maxlength="125" required>
                <div class="invalid-feedback">
                  Une courte description de la nouvelle est requise.
                </div>
              </div>
              <div class="col-3 mt-3">
                <select class="custom-select" name="fk_categorie">
                  <?php 
            ...
            <div class="form-row">
              ...
              <div class="col-12 mb-3">
                ...
                <textarea class="form-control" id="description_longue" name="description_longue" required></textarea>
                <div class="invalid-feedback">
            ...
            <select class="custom-select" id="actif" name="actif">
